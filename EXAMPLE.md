...
mp_C_appr1 = mphdot(mphA, A, 'dense'); % use precision u1 to simiulate product, and output array format
mp_C_appr2 = mphdot(mphA, mphA); % use precision u2 to simiulate product, and output HODLR format
