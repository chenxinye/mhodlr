...
function C = inverse_hodlr(obj)
    ...
    if isempty(obj.D)
        ...
        [C.U1, C.V2] = compress_m(hdot_dense(hdot_dense(C.A11, -A12), X22), obj.method, obj.vareps, obj.max_rnk, obj.trun_norm_tp, obj.issparse);
        C21 = -hdot_dense(hdot_dense(X22, A21), C.A11);
        [C.U2, C.V1] = compress_m(C21, obj.method, obj.vareps, obj.max_rnk, obj.trun_norm_tp, obj.issparse);
...
function C = inverse_dense(obj)
    ...
    if strcmp(class(obj), 'amphodlr') | strcmp(class(obj), 'hodlr')
        if isempty(obj.D)
            ...
            A12 = obj.U1*obj.V2;
            A21 = obj.U2*obj.V1;
            X11 = inverse_dense(hadd_partial_hodlr(obj.A11, A12 * X22 * A21 ,'-', true));
            C12 = -X11 * A12 * X22;
            C21 = -X22 * A21 * X11;
