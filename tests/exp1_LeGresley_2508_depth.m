...
exportgraphics(gca, 'figures/LeGresley_2508_depth=1.pdf')
hold off
...
set(l,'interpreter','latex');
l.FontSize = fontSize+7;
exportgraphics(gca, 'figures/LeGresley_2508_depth=2.pdf')
hold off
...
set(l,'interpreter','latex');
l.FontSize = fontSize+7;
exportgraphics(gca, 'figures/LeGresley_2508_depth=3.pdf')
hold off