...
hold on 
semilogy(1:n_eps, err_back_list2(:, 1)./n_sample,'--g', 'Marker', '*', 'MarkerSize',markerSize, 'Linewidth',lineWidth)
hold on 
...
hold on 
semilogy(1:n_eps, err_back_list2(:, 2)./n_sample,'--g', 'Marker', '*', 'MarkerSize',markerSize, 'Linewidth',lineWidth)
hold on 
...
hold on 
semilogy(1:n_eps, err_back_list2(:, 3)./n_sample,'--g', 'Marker', '*', 'MarkerSize',markerSize, 'Linewidth',lineWidth)
hold on 
